...
public class EngineerMyMeetingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_engineer_my_meeting);
		
		dm = new DisplayMetrics();
		getWindowManager().getDefaultDisplay().getMetrics(dm);
		
		listView = (ListView) findViewById(R.id.listView_my_meeting);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				startActivityForResult(new Intent(EngineerMyMeetingActivity.this, WebActivity.class)
		...
		findViewById(R.id.iv_my_meeting_back).setOnClickListener(new OnClickListener() {
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(int position, View v, ViewGroup parent) {
			...
			if(v == null)
		    {
		        v = mInflater.inflate(R.layout.item_meeting_my, null);
		        h = new ViewHolder();
		        h.tvName = (TextView) v.findViewById(R.id.textView_meeting_my_name);
		        h.tvTime = (TextView) v.findViewById(R.id.textView_meeting_my_time);
		        h.tvAddress = (TextView) v.findViewById(R.id.textView_meeting_my_address);
		        v.setTag(h);
		    }else
		    {
