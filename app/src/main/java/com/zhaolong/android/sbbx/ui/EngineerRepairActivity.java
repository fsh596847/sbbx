...
public class EngineerRepairActivity extends Activity {
  ...
  //小结
  private EditText etBriefsummary;
  ...
  private OnClickListener onClickListener = new OnClickListener() {
    @Override public void onClick(View v) {
      if (v.getId() == R.id.cb_yes) {
        ischangeparts = "1";
        cbYes.setChecked(true);
        cbNo.setChecked(false);
      } else if (v.getId() == R.id.cb_no) {
        ischangeparts = "0";
  ...
  private void initViews() {
    ...
    etBriefsummary = (EditText) findViewById(R.id.et_repair_briefsummary);
    ...
    cbYes.setOnClickListener(onClickListener);
    cbNo.setOnClickListener(onClickListener);
  }
      ...
      public void run() {
        ...
        try {
          String s = DataService.FinishOrder(EngineerRepairActivity.this
              ...
              , orderid, parts, ischangeparts, etBriefsummary.getText().toString());
          mLog.d("http", "s:" + s);
